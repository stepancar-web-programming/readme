...
### G5 Промежуточные результаты групповая защита (2) 6 баллов
...
|  | Оценка | Минимальный балл | Макимальный балл |
|--|--------|------------------|------------------|
|G6.0| 100% фичей реализовано | 2.4           | 4 |
|G6.1| Презентация результата | 0             | 0 |
