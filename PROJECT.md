...
### G6-G6 Финальные результаты 18 баллов
|  | До 14.01  | до 20.01| после 20.01 |
|--|----------|----------|----------|
|T| 1        | 0.8      | 0.6
...
|R | Оценка | Минимальный балл | Максимальный балл |
|--|--------|------------------|------------------|
|G5.2| К проекту подключена аналитика  | 0.6            | 1            |
|G5.3| Все техничесские требования к серверу выполнены   | 1.2            | 2           |
|G5.4| Внешняя библиотека компонентов использована | 0.6  | 1  |
|G5.5| Использованы WebApi из списка требований | 1.2 | 2 |
|G6.0| 100% фичей реализовано | 1.8           | 5 |
|G6.1| Презентация результата | 0.6           | 1 |
|G6.2| Все техничесские требования к клиенту выполнены |           | |

### I2 Индивидуальная защита 28 баллов
...
|I2.1| [Теоретический вопрос](./thereticalQuestions.mjs) | 8.4        | 14|
...
I2.0 / I2.1 засчитывается автоматом студентам с набранным количеством баллов больше либо равным 76.
