...
## 20.10.2022 Рубежная работа 1

## 22.10.2022 33201, 29.10.2022 33211

Поговорили про наличие 2х разных способов создания компонентов - [Классы и функции](https://reactjs.org/docs/components-and-props.html#function-and-class-components).

Поговорил и понятии жизненный цикл. Разобрали методы жизненного цикла react компонентов. Рассматривали последоватьельностть вызовов этих методов. Рассматривали назначение.

Обсудили проблему лишних ре-рендеров и [способы решения этой проблемы](https://reactjs.org/docs/optimizing-performance.html#shouldcomponentupdate-in-action). Разобрали как работать с `shouldComponentUpdate`, `PureComponent`, поговорили о том, чем могут помочь иммутабельные структуры данных

Разобрались как устанавливать состояние компонениа с помощью [setState](https://reactjs.org/docs/faq-state.html#what-does-setstate-do) и [useState](https://reactjs.org/docs/hooks-reference.html#usestate)

## 03.11.2022 33201 33211

UI библиотеки
Декларативное / Императивное программирование применительно к UI
Обновление представления при изменении данных.
Рассмотрели механизмы:
* ручное уведомление библиотеки об изменениях данных
* автоматическое слежение за изменениями по таймеру
* monkey patching асинхронных функций
* observer за данными на примере сеттера функции в knockoutjs
* observer за данными на примере es decorators
Поговорили про плюсы/ минусы/ сложности


## 05.11.2022 33201 12.11.2022 33211
Разговаривали про [flux архитектуру](https://facebook.github.io/flux/)
Рассматривали  применение на примере задачи трансляции состояния приложения, другому клиенту. Упомянули про [redux](https://redux.js.org/) и то, какая разница между чистым flux и redux.

## 17.11.2022 33201 33211
Тестирование web приложений. Задачи тестиро
Говорили о пирамиде тестирования, фигурах тестирования
Разбирали примеры unit тестов написанных на [jest](https://jestjs.io/)
Говорили про snapshot тесты
Рассматривали e2e тесты с использованием [cypress](https://www.cypress.io/)
Говорили про скриншот тесты
Обсудили для чего нужен [react-testing-library](https://testing-library.com/docs/react-testing-library/intro/) и [testing-libary](https://testing-library.com/) в целом

## 19.11.2022 33201 26.11.2022 33211
Разбирали пример на реакте с отображением списка продуктов, деталей о продукте.
Говорили про различные способы возможной организации взаимосвязи компонентов.
Говорили про структуру данных. Немного поговорили про стурктуру данных для отображения денег.
В одной из групп успели поговорить про компоненты ячейки. 
Поговорили про [Component children](https://reactjs.org/docs/jsx-in-depth.html#children-in-jsx) и как им пользоваться

## 03.12.2022 33201 не пришли :(
